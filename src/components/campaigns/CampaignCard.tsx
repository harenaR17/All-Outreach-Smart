...
export function CampaignCard({ campaign, onDelete, onTogglePause, onDuplicate }: Props) {
  ...
  return (
    <div className="group relative bg-zinc-900/40 border border-zinc-800 hover:border-indigo-700/80 rounded-2xl p-5 transition-all hover:bg-zinc-900/60 cursor-pointer"
        ...
        <div className="ml-auto flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          {onDuplicate && (
            <button
              ...
              className="p-1.5 rounded-lg text-zinc-400 hover:text-green-100 hover:bg-green-500/20 transition-colors cursor-pointer"
          ...
          {onTogglePause && (campaign.status === 'active' || campaign.status === 'paused') && (
            <button
              ...
              className="p-1.5 rounded-lg text-zinc-400 hover:text-amber-800 hover:bg-amber-300/20 transition-colors cursor-pointer"
